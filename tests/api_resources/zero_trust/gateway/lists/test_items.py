...
class TestItems:
    ...
    def test_method_list(self, client: Cloudflare) -> None:
        ...
        assert_matches_type(SyncV4PagePaginationArray[GatewayItem], item, path=["response"])
...
class TestAsyncItems:
    ...
    async def test_method_list(self, async_client: AsyncCloudflare) -> None:
        ...
        assert_matches_type(AsyncV4PagePaginationArray[GatewayItem], item, path=["response"])
