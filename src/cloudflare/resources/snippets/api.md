...
- <code title="get /zones/{zone_id}/snippets/snippet_rules">client.snippets.rules.<a href="./src/cloudflare/resources/snippets/rules.py">get</a>(\*, zone_id) -> <a href="./src/cloudflare/types/snippets/rule_get_response.py">SyncSinglePage[RuleGetResponse]</a></code>
