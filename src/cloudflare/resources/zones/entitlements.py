...
from ...types.zones.entitlement_list_response import EntitlementListResponse
    ...
    def list(
        ...
        *,
        ...
        return self._get_api_list(
            path_template("/zones/{zone_id}/entitlements", zone_id=zone_id),
