...
- <code title="put /user/tokens/{token_id}/value">client.user.tokens.value.<a href="./src/cloudflare/resources/user/tokens/value.py">update</a>(token_id) -> <a href="./src/cloudflare/types/shared/token_value.py">str</a></code>
