...
class ScrapeResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        elements: Iterable[scrape_create_params.Variant0Element] | Omit = omit,
    ...
    def create(
        ...
        *,
        ...
        elements: Iterable[scrape_create_params.Variant1Element] | Omit = omit,
        emulate_media_type: str | Omit = omit,
    ...
    def create(
        ...
        *,
        ...
        | Iterable[scrape_create_params.Variant1Element]
        | Omit = omit,
        emulate_media_type: str | Omit = omit,
