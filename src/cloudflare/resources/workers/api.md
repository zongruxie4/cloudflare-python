...
- <code title="delete /accounts/{account_id}/workers/workers/{worker_id}">client.workers.beta.workers.<a href="./src/cloudflare/resources/workers/beta/workers/workers.py">delete</a>(worker_id, \*, account_id, \*\*<a href="src/cloudflare/types/workers/beta/worker_delete_params.py">params</a>) -> <a href="./src/cloudflare/types/workers/beta/worker_delete_response.py">WorkerDeleteResponse</a></code>
...
- <code title="get /accounts/{account_id}/workers/scripts/{script_name}/deployments">client.workers.scripts.deployments.<a href="./src/cloudflare/resources/workers/scripts/deployments.py">list</a>(script_name, \*, account_id, \*\*<a href="src/cloudflare/types/workers/scripts/deployment_list_params.py">params</a>) -> <a href="./src/cloudflare/types/workers/scripts/deployment_list_response.py">SyncV4PagePagination[DeploymentListResponse]</a></code>
